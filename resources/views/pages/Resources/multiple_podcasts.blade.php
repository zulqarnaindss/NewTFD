                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="h-border-NBL">
                                <ul class="filterz option-setz exclusive" data-filter-group="status">
                                    ...
                                    <li><a href="#" data-filter-value=".podcast" class="selectedz">Podcast</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="gridz">
                                        <div class="col">
                                            <div class="d-flex align-items-stretch">
                                                <div class="itemz yoi podcast incomplete Eql-NBL ">
                                                    <div>
                                                    ...
                                                    <div class="d-grid">
                                                        <a href="" class=" text-decoration-none">Read the Podcast <i class="bi-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
