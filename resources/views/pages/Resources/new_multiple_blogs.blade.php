                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="h-border-NBL">
                                <ul class="filterz option-setz exclusive" data-filter-group="status">
                                    <li><a href="#" data-filter-value=".blog" class="selectedz">Blogs</a></li>
                                        ...
                                        <div class="col">
                                            <div class="d-flex align-items-stretch">
                                                <div class="itemz yoi blog incomplete Eql-NBL ">
                                                    <div>
                                                        <img src="{{asset('assets')}}/images/blogs-media/blogs/boost-your-sales-efficiency-img1.webp" class="img-fluid w-100 mb-3" alt="" />
                                                    ...
                                                    <div class="d-grid">
                                                        <a href="" class=" text-decoration-none">Read the blog <i class="bi-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
