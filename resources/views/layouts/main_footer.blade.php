<!-- Blog Section -->
<section class="blog-sec-TFD">
    <div class="container px-md-5">
        <div class="container-lg">
            <div class="row">
                <div class="col-xl-12">
                    <div class=" text-center flex-wrap align-items-center">
                        <img src="https://dynamicsstream.co.uk/newassets/images/brand/microsoft-logo.png" class="micro-solu-logo img-fluid mr-right-logos" alt="Microsoft Logo" width="160">
                        <img src="https://dynamicsstream.co.uk/newassets/images/brand/shopify-logo.png" class="img-fluid mr-right-logos" alt="Shopify Logo" width="160">
                        <img src="https://dynamicsstream.co.uk/newassets/images/brand/micro-gold-logo.png" class="micro-solu-logo img-fluid mr-right-logos" alt="Microsoft Gold Logo" width="160">
                        <img src="https://dynamicsstream.co.uk/newassets/images/brand/iso-img.png" class="img-fluid mr-right-logos iso-m-w" alt="Microsoft Gold Logo" width="160">
                        <img src="https://dynamicsstream.co.uk/newassets/images/brand/hubspot-logo.png" class="img-fluid logos-w-for-m m-hb-spt-w" alt="Hubspot Logo" width="160">
                    </div>
                </div>
            </div>
        </div>
        <div class="mrgn-top-3rem">
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="blog-card home-p-blog">
                        <div>
                            <img src="{{asset('assets')}}/images/home/blog.webp" class="img-fluid w-100 mb-4" alt="">
                            <h6 class="mb-4">Blogs</h6>
                            <p class="mb-4 excerpt">With the emergence of generative AI, the landscape of retail automation is undergoing a profound transformation.</p>
                        </div>
                        <div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="blog-card home-p-blog">
                        <div>
                            <img src="{{asset('assets')}}/images/home/case-study.webp" class="img-fluid w-100 mb-4" alt="">
                            <h6 class="mb-4">Case Studies</h6>
                            <p class="mb-4 excerpt">With the emergence of generative AI, the landscape of retail automation is undergoing a profound transformation.</p>
                        </div>
                        <div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="blog-card home-p-blog">
                        <div>
                            <img src="{{asset('assets')}}/images/home/white-paper.webp" class="img-fluid w-100 mb-4" alt="">
...
<footer>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mb-3">
                        ...
                        <ul class="footer-nav">
                            ...
                            <li><a href="/app-development-services">Mobile App Development</a></li>
                            <li><a href="/search-engine-optimization">Search Engine Optimization</a></li>
                        </ul>
                    </div>
                    <div class="col-xl-3 col-md-6 mb-3">
                        <h6>Future Dynamics</h6>
                        <ul class="footer-nav">
    ...
    <div class="foot-card-sec-about">
        <div class="Custom-footer-ND">
            <div class="container">
                <div class="warpper-ND">
                    <input class="radio-ND" id="one" name="group" type="radio" checked>
                    <input class="radio-ND" id="two" name="group" type="radio">
                    <input class="radio-ND" id="three" name="group" type="radio">
                    <input class="radio-ND" id="four" name="group" type="radio">
                    <div class="tabs-ND">
                        <div class="row ">
                            <div class="col-xl-3 col-md-3">
                                <label class="tab-ND" id="one-tab" for="one">United Arab Emirates</label>
                            </div>
                            <div class="col-xl-3 col-md-3">
                                <label class="tab-ND" id="two-tab" for="two">United Kingdom</label>
                            </div>

                            <div class="col-xl-3 col-md-3">
                                <label class="tab-ND" id="three-tab" for="three">United State of America</label>
                            </div>
                            <div class="col-xl-3 col-md-3">
                                <label class="tab-ND" id="four-tab" for="four">Pakistan</label>
                            </div>
                        </div>
                    </div>
                    <div class="panels-ND ">
                        <div class="panel-ND" id="one-panel">
                            <div class="row ">
                                <div class="col-xl-4 col-md-4 pad-lef-for-new-la">
                                    <img src="{{asset('assets')}}/images/footer/future-footer.webp" class="ds-logo-N footer-logo-TFD" alt="" />
                                    <p>1803 The Metropolis Tower <br> Business Bay | Downtown</p>
                                    <p class="mrgn-btm-5">For Sales, Support & Enquiries
                                    <p class="mrgn-btm-5"><a href="tel:+971044373103" class="anch-color">+971 (04) 437 3103</a></p>
                                    <p class="mrgn-btm-5"><a href="tel:+971527684867" class="anch-color">+ 971 52 768 4867</a></p>
                                    <div class="socl-ic-ND">
                                        <div class=" mb-4">
                                            <a href="https://www.linkedin.com/company/31212572/admin/feed/posts/" target="_blank" class="btn social-footr-icns-uk row-pdng-left-zero">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="40" viewBox="0 0 87 80" fill="none">
                                            ...
                                            <a href="https://www.youtube.com/channel/UCRYG9NsTDnGETvb7y2hw5JA" target="_blank" class="btn social-footr-icns-uk">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="37" height="60" viewBox="0 0 110 100" fill="none">
                                            ...
                                            <a href="https://www.instagram.com/digitalfuturedynamics/?igshid=OGQ5ZDc2ODk2ZA%3D%3D" target="_blank" class="btn social-footr-icns-uk">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="46" viewBox="0 0 89 86" fill="none">
                                            ...
                                            <a href="" target="_blank" class="btn social-footr-icns-uk">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="40" viewBox="0 0 77 76" fill="none">
                                ...
                                <div class="col-xl-8 col-md-8 pad-lef-for-new-la bg-map-NH-UAE img-NF-RIGHT">
                                </div>
                            </div>
                        </div>
                        <div class="panel-ND" id="two-panel">
                            <div class="row ">
                                <div class="col-xl-4 col-md-4 pad-lef-for-new-la">
                                    <img src="{{asset('assets')}}/images/footer/future-footer.webp" class="ds-logo-N footer-logo-TFD" alt="" />
                                    <p>Stembridge Road <br> London-United Kingdom</p>
                                    <p class="mrgn-btm-5">For Sales, Support & Enquiries</p>
                                    <p class="mrgn-btm-5"><a class="anch-color" href="tel:+447376588837">+44 7376 588837</a></p>
                                    <div class="socl-ic-ND">
                                        <div class=" mb-4">
                                            <a href="https://www.linkedin.com/company/31212572/admin/feed/posts/" target="_blank" class="btn social-footr-icns-uk row-pdng-left-zero">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="40" viewBox="0 0 87 80" fill="none">
                                ...
                                <div class="col-xl-8 col-md-8 pad-lef-for-new-la bg-map-NH-UK img-NF-LEFT">
                                </div>
                            </div>
                        </div>

                        <div class="panel-ND" id="three-panel">
                            <div class="row ">
                                <div class="col-xl-4 col-md-4 pad-lef-for-new-la">
                                    <img src="{{asset('assets')}}/images/footer/future-footer.webp" class="ds-logo-N footer-logo-TFD" alt="" />
                                    <p>2000 Cropsey Ave <br> Brooklyn - New York <br>Post Code 11214</p>
                                    <p class="mrgn-btm-5">For Sales, Support & Enquiries</p>
                                    <p class="mrgn-btm-5"><a href="tel:+14158004787" class="anch-color">+1 (415) 800-4787</a></p>
                                    <div class="socl-ic-ND">
                                        <div class=" mb-4">
                                            <a href="https://www.linkedin.com/company/31212572/admin/feed/posts/" target="_blank" class="btn social-footr-icns-uk row-pdng-left-zero">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="40" viewBox="0 0 87 80" fill="none">
                                ...
                                <div class="col-xl-8 col-md-8 pad-lef-for-new-la bg-map-NH-USA img-NF-TOP-R">
                                </div>
                            </div>
                        </div>
                        <div class="panel-ND" id="four-panel">
                            <div class="row ">
                                <div class="col-xl-4 col-md-4 pad-lef-for-new-la">
                                    <img src="{{asset('assets')}}/images/footer/future-footer.webp" class="ds-logo-N footer-logo-TFD" alt="" />
                                    <p>Johar Town <br>Lahore</p>
                                    <p class="mrgn-btm-5">For Sales, Support & Enquiries</p>
                                    <p class="mrgn-btm-5"><a href="mailto:sales@dynamicsstream.co.uk" class="anch-color">sales@dynamicsstream.co.uk</a></p>
                                    <div class="socl-ic-ND">
                                        <div class=" mb-4">
                                            <a href="https://www.linkedin.com/company/31212572/admin/feed/posts/" target="_blank" class="btn social-footr-icns-uk row-pdng-left-zero">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="27" height="40" viewBox="0 0 87 80" fill="none">
                                ...
                                <div class="col-xl-8 col-md-8 pad-lef-for-new-la bg-map-NH-PAK img-NF-TOP-L">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid bg-NFD">
            <div class="row align-items-center">
                <div class="col-xl-12 bg-pdng-NFD">
                    <p class="mb-2 small text-center text-white">All Rights Reserved.<a href="/" class="text-white" style="text-decoration: none;"> the Future Dynamics</a> A Brand of Dynamics Stream® is a registered trademark. <a href="/privacy-policy" class="text-white">Privacy</a> | <a href="/terms-and-conditions" class="text-white">Terms & Conditions</a> | <a href="/cookie-policy" class="text-white">Cookie Policy</a></p>
                </div>
            </div>
        </div>
</footer>